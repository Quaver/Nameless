...
func (h *Handler) convertToDbScore() db.Score {
	return db.Score{
		...
		CountPerf:                   int(h.scoreData.CountPerf),
		CountGreat:                  int(h.scoreData.CountGreat),
		CountGood:                   int(h.scoreData.CountGood),
		CountOkay:                   int(h.scoreData.CountOkay),
		CountMiss:                   int(h.scoreData.CountMiss),
		Grade:                       common.GetGradeFromAccuracy(h.scoreData.Accuracy, h.scoreData.Failed),
